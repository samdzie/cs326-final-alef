...
if (idParam) {
    ...
    if (updateButton) {
        ...
        updateButton.setAttribute("onclick", "client.createHandler()");
    }
}

export function createHandler() {
    (async () => {
        await restroomCreate();
        await restroomUpdate();
    })();
}
...
export async function restroomCreate() {
    // send POST request
    const data = {};
...
export async function restroomRead() {
    // send POST request
    const data = {
        "id" : id
    };
...
export async function restroomUpdate() {
...
export async function restroomDelete() {
    // send POST request
    const data = {
        "id" : id
    };
